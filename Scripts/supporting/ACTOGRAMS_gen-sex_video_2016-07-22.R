...
{# define constants
load(paste(wd,"prep_for_ACTOS.Rdata",sep=""))
...
#"C:/Users/mbulla/Documents/ownCloud/ACTOS_2013_barrow-time"
...
outdir = "C:/Users/mbulla/Documents/ownCloud/ACTOS_Bip_unip_local_time"
#"\\\\ds\\RAW_DATA_KEMP\\FIELD\\Barrow\\2011\\DOCS\\actograms\\2015_Feb"	
 }}}
}
...
RFID.temperature_actogram = function(dfr,gps,yr, type, show=FALSE,utc=TRUE) {
        ...
        if (type =='PDF') {
           tf = paste0(outdir,'/',dfr$nest[1],yr, ".pdf")
           pdf(tf, paper = "a4", width = 8, height = 11.6929134)
		}
		if (type =='PNG') { # ASK ANNE HOW THIS WORKS
		 if(utc==TRUE){tf = paste0(outdir,'/',paste(dfr$nest[1],yr,sep="_"), "_true-local_%03d.png")}else{ # %03d - three position digit file name)
          tf = paste0(outdir,'/',paste(dfr$nest[1],yr,sep="_"), "_%03d.png")} # %03d - three position digit file name
...
nests=c('a303','a305','a403','a802','b303','b304','b402','b403','b404','b405','b601','d702','l301','l302','l401','s1003','s111','s201','s304','s305','s310','s313','s318','s325','s417','s419','s420','s422','s502','s506','s509','s511','s609','s610','s704','s705','s706','s708','s711','s712','s716','s717','s720','s777','s804','s807','s812','s813','s815','s829','s901','s902') # deserted 2012
